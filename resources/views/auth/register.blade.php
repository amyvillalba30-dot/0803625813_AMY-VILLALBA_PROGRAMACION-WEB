        ...
        <div class="col-md-5">
            <div class="card auth-card">
                <div class="card-header">
                    <i class="bi bi-person-plus me-2 text-success"></i>{{ __('Register') }}
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mt-4 text-center">
                            <p class="text-secondary small mb-0">¿Ya tienes una cuenta? 
                                <span class="auth-links"><a href="{{ route('login') }}">Inicia sesión aquí</a></span>
                            </p>
                        </div>
                    </form>
                </div>
